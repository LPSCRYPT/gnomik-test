...
uint256 constant _tableId = uint256(bytes32(abi.encodePacked(bytes16("gnomik"), bytes16("HistoryTable"))));
uint256 constant HistoryTableTableId = _tableId;

library HistoryTable {
